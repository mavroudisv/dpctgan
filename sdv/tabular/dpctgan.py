...
from ctgan import dpCTGANSynthesizer

from sdv.tabular.base import BaseTabularModel


class dpCTGANModel(BaseTabularModel):
    """Base class for all the dpCTGAN models.
...
class dpCTGAN(dpCTGANModel):
    ...
    _MODEL_CLASS = dpCTGANSynthesizer
